use summand_app::{
    ...
    capability::{SummandCapability, SummandCapabilityType},
    command::Command,
    core::SummandRunner,
    strategy::{RunBreakStrategy, RunRetryStrategy, RunStrategies, SummandStrategy},
    summand::Summand,
};
...
pub fn create_summand() -> Summand {
    ...
    echo_summand.strategy =
        SummandStrategy::new(RunStrategies::Retry(RunRetryStrategy::new(Some(2))));
    return echo_summand;
}
